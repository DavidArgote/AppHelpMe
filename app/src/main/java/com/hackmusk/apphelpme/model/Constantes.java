...
public class Constantes {
    ...
    public static String PUBLIC_COLUMN_2 = "NAME_USER";
    ...
    public static String CREATE_TABLE_PUBLIC = "CREATE TABLE " + NAME_TABLE_PUBLIC + "(" + PUBLIC_COLUMN_1 + " INTEGER PRIMARY KEY AUTOINCREMENT," +
            PUBLIC_COLUMN_2 + " TEXT," + PUBLIC_COLUMN_3 + " TEXT," + PUBLIC_COLUMN_4 + " TEXT," + PUBLIC_COLUMN_5 + " TEXT,"
            + PUBLIC_COLUMN_6 + " TEXT," + PUBLIC_COLUMN_7 + " TEXT)";
